...
import { useCredentialContext } from './credentialsContext';
...
export default function RecordProvider({children}: {children:React.ReactNode}) {
    ...
    const {credentials:credentials} = useCredentialContext();
    ...
    const fetchRecords = useCallback(() => {
        getRecords({setRecordsData: setRecords, userEmail: credentials.UserEmail});
    }, []);
